...
export default function SamsungSPage() {
  ...
  const fetchModels = async () => {
    setLoading(true);
    try {
      const response = await fetch(`/api/admin/models?brand=samsung&series=z&t=${Date.now()}`, {
        cache: 'no-store'
      });
      if (response.ok) {
      ...
      <section className="py-16 bg-gradient-to-br from-pink-50 via-yellow-50 to-white">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Samsung Galaxy Z reparation
          </h1>
          <p className="text-xl text-gray-600 mb-4">
            Samsung Galaxy Z reparation – skærm, batteri, kamera & ladeport
          </p>
          <p className="text-lg text-gray-500 max-w-3xl mx-auto">
            Vi tilbyder reparation af alle Samsung Galaxy Z-modeller med hurtig udførsel og garanti. Se pris på skærmskift, batteriskift, kamera- og ladeportsreparationer ved at vælge din model herunder.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="max-w-xl mx-auto mb-8">
            <input
              type="text"
              placeholder="Søg model... fx 'Fold6', 'Flip5', '2024'"
              value={searchTerm}
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Populære Samsung Galaxy Z reparationer
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl text-center shadow-sm">
              ...
              <p className="text-gray-600">Udskiftning af ødelagte skærme på alle Galaxy Z-modeller med 24 måneders garanti.</p>
            </div>
            <div className="bg-white p-8 rounded-xl text-center shadow-sm">
            ...
            <div className="bg-white p-8 rounded-xl text-center shadow-sm">
              ...
              <p className="text-gray-600">Reparation af opladningsproblemer på alle Galaxy Z-modeller.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 mb-4 italic">
                "Fantastisk service! Min Galaxy Z blev repareret på under 30 minutter direkte på min arbejdsplads. Kan varmt anbefales!"
              </p>
