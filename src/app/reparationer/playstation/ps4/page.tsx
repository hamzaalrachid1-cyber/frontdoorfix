...
export default function PlayStationPS4Page() {
  const [searchTerm, setSearchTerm] = useState("");

  // Placeholder PlayStation PS4 models
  const ps4Models: ModelData[] = [
    {
      id: "ps4-pro",
      name: "PlayStation 4 Pro",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2016",
      description: "PS4 Pro konsol med 4K understøttelse"
    },
    {
      id: "ps4-slim",
      ...
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2016",
      description: "PS4 Slim konsol med reduceret størrelse"
    },
    {
      id: "ps4-original",
      ...
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2013",
      description: "Original PS4 konsol"
    }
  ];

  const filteredModels = ps4Models.filter((model) =>
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-4">
            PlayStation PS4 reparationer – Hurtigt & Nemt
          </h1>
          <p className="text-xl sm:text-2xl font-light opacity-90 mb-8">
            Vi reparerer alle PlayStation PS4 modeller – skærm, batteri, og mere. Få din PS4 som ny igen!
          </p>
          <div className="max-w-md mx-auto">
            <input
              type="text"
              placeholder="Søg efter PS4 model..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {filteredModels.length === 0 && (
          <p className="text-center text-gray-600 text-lg">Ingen PlayStation PS4 modeller fundet, der matcher din søgning.</p>
        )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {filteredModels.map((model) => (
            <Link
              key={model.id}
              href={`/reparationer/playstation/${model.id}`}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Om PlayStation PS4 reparation – hurtigt, sikkert og gennemsigtigt
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-600 mb-6">
                PlayStation PS4 modeller er kendt for deres ydeevne og design. Når uheldet er ude, 
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Ny skærm til PlayStation PS4</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Nyt batteri til PlayStation PS4</h3>
              <p className="text-gray-600 text-sm mb-6">
