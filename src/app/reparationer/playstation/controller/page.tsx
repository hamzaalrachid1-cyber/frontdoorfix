...
export default function PlayStationControllerPage() {
  const [searchTerm, setSearchTerm] = useState("");

  // Placeholder PlayStation Controller models
  const controllerModels: ModelData[] = [
    {
      id: "dualsense",
    ...
    },
    {
      ...
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2013",
      description: "PS4 DualShock 4 controller"
    }
  ];

  const filteredModels = controllerModels.filter((model) =>
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-4">
            PlayStation Controller reparationer – Hurtigt & Nemt
          </h1>
          <p className="text-xl sm:text-2xl font-light opacity-90 mb-8">
            Vi reparerer alle PlayStation Controller modeller – skærm, batteri, og mere. Få din Controller som ny igen!
          </p>
          <div className="max-w-md mx-auto">
            <input
              type="text"
              placeholder="Søg efter Controller model..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {filteredModels.length === 0 && (
          <p className="text-center text-gray-600 text-lg">Ingen PlayStation Controller modeller fundet, der matcher din søgning.</p>
        )}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Om PlayStation Controller reparation – hurtigt, sikkert og gennemsigtigt
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-600 mb-6">
                PlayStation Controller modeller er kendt for deres ydeevne og design. Når uheldet er ude, 
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Ny skærm til PlayStation Controller</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Nyt batteri til PlayStation Controller</h3>
              <p className="text-gray-600 text-sm mb-6">
