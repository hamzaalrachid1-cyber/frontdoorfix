...
export default function AppleMacBookPage() {
  const [searchTerm, setSearchTerm] = useState("");

  // Placeholder Apple MacBook models
  const macbookModels: ModelData[] = [
    {
      id: "macbook-air-m3",
      name: "MacBook Air M3",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2024",
      description: "MacBook Air med M3 chip"
    },
    {
      id: "macbook-pro-m3",
      name: "MacBook Pro M3",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2023",
      description: "MacBook Pro med M3 chip"
    },
    {
      id: "macbook-air-m2",
      name: "MacBook Air M2",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2022",
      description: "MacBook Air med M2 chip"
    }
  ];
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-4">
            Apple MacBook reparationer – Hurtigt & Nemt
          </h1>
          <p className="text-xl sm:text-2xl font-light opacity-90 mb-8">
            Vi reparerer alle Apple MacBook modeller – skærm, batteri, og mere. Få din MacBook som ny igen!
          </p>
          <div className="max-w-md mx-auto">
            <input
              type="text"
              placeholder="Søg efter MacBook model..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {filteredModels.length === 0 && (
          <p className="text-center text-gray-600 text-lg">Ingen Apple MacBook modeller fundet, der matcher din søgning.</p>
        )}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Om Apple MacBook reparation – hurtigt, sikkert og gennemsigtigt
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-600 mb-6">
                Apple MacBook modeller er kendt for deres ydeevne og design. Når uheldet er ude, 
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Ny skærm til Apple MacBook</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Nyt batteri til Apple MacBook</h3>
              <p className="text-gray-600 text-sm mb-6">
