...
export default function WindowsStationaerPCPage() {
  const [searchTerm, setSearchTerm] = useState("");

  // Placeholder Windows StationaerPC models
  const stationaerpcModels: ModelData[] = [
    {
      id: "gaming-pc",
      name: "Gaming PC",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2023",
      description: "Gaming stationær PC"
    },
    {
      id: "office-pc",
      name: "Office PC",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2023",
      description: "Office stationær PC"
    },
    {
      id: "workstation-pc",
      name: "Workstation PC",
      image: "/images/iphones/iphone-11.png", // Placeholder
      year: "2023",
      description: "Workstation stationær PC"
    }
  ];

  const filteredModels = stationaerpcModels.filter((model) =>
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-pink-500 to-purple-600 text-white py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight mb-4">
            Windows StationaerPC reparationer – Hurtigt & Nemt
          </h1>
          <p className="text-xl sm:text-2xl font-light opacity-90 mb-8">
            Vi reparerer alle Windows StationaerPC modeller – skærm, batteri, og mere. Få din StationaerPC som ny igen!
          </p>
          <div className="max-w-md mx-auto">
            <input
              type="text"
              placeholder="Søg efter StationaerPC model..."
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {filteredModels.length === 0 && (
          <p className="text-center text-gray-600 text-lg">Ingen Windows StationaerPC modeller fundet, der matcher din søgning.</p>
        )}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Om Windows StationaerPC reparation – hurtigt, sikkert og gennemsigtigt
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <p className="text-gray-600 mb-6">
                Windows StationaerPC modeller er kendt for deres ydeevne og design. Når uheldet er ude, 
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Ny skærm til Windows StationaerPC</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Nyt batteri til Windows StationaerPC</h3>
              <p className="text-gray-600 text-sm mb-6">
