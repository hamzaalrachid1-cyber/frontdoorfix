...
export const metadata = {
  title: 'Computer reparation – vælg kategori | FrontDoorFix',
  description: 'Computer reparation og service. Mac & PC • Computer. Hurtig service, gennemsigtige priser og garanti.',
  keywords: 'Computer, reparation, MacBook, iMac, Windows bærbar, stationær PC, København',
};

export default function ComputerBrandPage() {
  const brand = BRANDS.find((b) => b.slug === 'computer');
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-3">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900 font-medium">Computer</span>
          </nav>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Computer reparation – vælg kategori
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Hvorfor vælge FrontDoorFix til Computer reparation?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi har specialiseret os i Computer reparationer og kender alle modeller i detaljer
            </p>
          </div>
