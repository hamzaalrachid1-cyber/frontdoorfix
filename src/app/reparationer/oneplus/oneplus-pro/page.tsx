...
export default function OnePlusProPage() {
  const [searchTerm, setSearchTerm] = useState("");

  // OnePlus Pro models
  const proModels: ModelData[] = [
    {
      id: "oneplus-11",
      name: "OnePlus 11",
      image: "/images/iphones/oneplus-11.png",
      year: "2023",
    },
    {
      id: "oneplus-10t",
      name: "OnePlus 10T",
      image: "/images/iphones/oneplus-10t.png",
      year: "2022",
    }
  ];

  const filteredModels = proModels.filter((model) =>
  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="bg-gray-100 py-3 px-6">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>→</span>
            <span className="text-gray-800 font-medium">Pro</span>
          </div>
        </div>
      </nav>
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              <span className="bg-gradient-to-r from-pink-500 to-yellow-500 bg-clip-text text-transparent">
                OnePlus Pro Reparationer
              </span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Vi reparerer alle OnePlus Pro-modeller med originale dele og 24 måneders garanti. 
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <p className="text-lg text-gray-600 mb-6">
              Vi reparerer alle OnePlus Pro-modeller med originale eller kvalitetsgodkendte dele og op til 24 måneders garanti. 
      ...
      {/* OnePlus Pro Models Grid */}
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Vælg din OnePlus Pro-model
          </h2>

          {filteredModels.length === 0 && (
            <p className="text-center text-gray-600 text-lg">Ingen OnePlus Pro modeller fundet, der matcher din søgning.</p>
          )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {filteredModels.map((model) => {
              ...
              const isPopular = ["oneplus-11", "oneplus-10t"].includes(model.id);
      ...
      {/* OnePlus Pro Repairs SEO Section */}
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">OnePlus Pro Reparation i København</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi specialiserer os i OnePlus Pro reparationer med originale dele og 24 måneders garanti. 
