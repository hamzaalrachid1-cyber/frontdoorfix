...
export const metadata = {
  title: 'OnePlus reparation – vælg serie | FrontDoorFix',
  description: 'OnePlus reparation og service. Nord & Pro-serier • Android. Hurtig service, gennemsigtige priser og garanti.',
  keywords: 'OnePlus, reparation, Nord, Pro, Android, mobilreparation, København',
};

export default function OnePlusBrandPage() {
  const brand = BRANDS.find((b) => b.slug === 'oneplus');
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-3">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900 font-medium">OnePlus</span>
          </nav>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Hvorfor vælge FrontDoorFix til OnePlus reparation?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi har specialiseret os i OnePlus reparationer og kender alle modeller i detaljer
            </p>
          </div>
