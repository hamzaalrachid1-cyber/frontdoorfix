...
export const metadata = {
  title: 'Motorola reparation – vælg serie | FrontDoorFix',
  description: 'Motorola reparation og service. G & Edge-serier • Android. Hurtig service, gennemsigtige priser og garanti.',
  keywords: 'Motorola, reparation, G-serien, Edge-serien, Android, mobilreparation, København',
};

export default function MotorolaBrandPage() {
  const brand = BRANDS.find((b) => b.slug === 'motorola');
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-3">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900 font-medium">Motorola</span>
          </nav>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Motorola reparation – vælg serie
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Hvorfor vælge FrontDoorFix til Motorola reparation?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi har specialiseret os i Motorola reparationer og kender alle modeller i detaljer
            </p>
          </div>
