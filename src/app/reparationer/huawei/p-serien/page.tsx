...
export default function HuaweiPSerienPage() {
  const [searchTerm, setSearchTerm] = useState("");

  // Placeholder Huawei P models
  const pModels: ModelData[] = [
    {
      id: "huawei-p60-pro",
      name: "Huawei P60 Pro",
  ...
  const filteredModels = pModels.filter((model) =>
  ...
  return (
    <div className="min-h-screen">
      ...
      <nav className="bg-gray-100 py-3 px-6">
        <div className="mx-auto max-w-6xl">
          <div className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>→</span>
            <span className="text-gray-800 font-medium">P-serien</span>
          </div>
        </div>
      </nav>
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
              <span className="bg-gradient-to-r from-pink-500 to-yellow-500 bg-clip-text text-transparent">
                Huawei P-serien Reparationer
              </span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Vi reparerer alle Huawei P-modeller med originale dele og 24 måneders garanti. 
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <p className="text-lg text-gray-600 mb-6">
              Vi reparerer alle Huawei P-modeller med originale eller kvalitetsgodkendte dele og op til 24 måneders garanti. 
      ...
      {/* Huawei P Models Grid */}
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Vælg din Huawei P-model
          </h2>

          {filteredModels.length === 0 && (
            <p className="text-center text-gray-600 text-lg">Ingen Huawei P-modeller fundet, der matcher din søgning.</p>
          )}
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {filteredModels.map((model) => {
              ...
              const isPopular = ["huawei-p60-pro", "huawei-p60"].includes(model.id);
      ...
      {/* Huawei P Repairs SEO Section */}
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Huawei P Reparation i København</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi specialiserer os i Huawei P reparationer med originale dele og 24 måneders garanti. 
