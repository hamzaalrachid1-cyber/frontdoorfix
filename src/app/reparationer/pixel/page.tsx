...
export const metadata = {
  title: 'Google Pixel reparation – vælg serie | FrontDoorFix',
  description: 'Google Pixel reparation og service. Pixel-serien • Android. Hurtig service, gennemsigtige priser og garanti.',
  keywords: 'Google Pixel, reparation, Pixel-serien, Android, mobilreparation, København',
};

export default function PixelBrandPage() {
  const brand = BRANDS.find((b) => b.slug === 'pixel');
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="mx-auto max-w-6xl px-6 py-3">
          <nav className="text-sm text-gray-600">
            ...
            <span className="mx-2">›</span>
            <span className="text-gray-900 font-medium">Google Pixel</span>
          </nav>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Google Pixel reparation – vælg serie
            </h1>
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-8">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">
              Hvorfor vælge FrontDoorFix til Google Pixel reparation?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Vi har specialiseret os i Google Pixel reparationer og kender alle modeller i detaljer
            </p>
          </div>
