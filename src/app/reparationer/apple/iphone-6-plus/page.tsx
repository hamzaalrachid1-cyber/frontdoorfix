...
export default function iPhone6PlusPage() {
  const repairs = [
    {
      id: "skærm-original",
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center text-white">
            ...
            <p className="text-xl mb-8">
              Vi reparerer din iPhone 6 Plus med originale dele og 24 måneders garanti
            </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">
            Reparationer for iPhone 6 Plus
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {repairs.map((repair) => (
              <div key={repair.id} className="bg-white rounded-lg shadow-lg p-6">
                ...
                <a
                  href={`/bestil?model=iphone-6-plus&repair=${repair.id}`}
