...
export const metadata: Metadata = {
  title: "iPhone 6 Plus Reparation - Frontdoorfix",
  description: "Vi tilbyder reparation af iPhone 6 Plus – skærm, batteri, kamera, ladeport og mere med 24 måneders garanti. Hurtig service direkte på din adresse i København.",
  keywords: "iPhone 6 Plus reparation, skærmreparation iPhone 6 Plus, batteriskift iPhone 6 Plus, kamera reparation, ladeport reparation, København",
};

export default function iPhone6PlusRepair() {
  const repairs = [
    {
    ...
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Professionel reparation af din iPhone 6 Plus med originale Apple dele og 24 måneders garanti.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                <strong>Vi tilbyder reparation af iPhone 6 Plus</strong> – skærm, batteri, kamera, ladeport og mere med 24 måneders garanti. 
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Priser for iPhone 6 Plus reparationer</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Hvorfor vælge Frontdoorfix til din iPhone 6 Plus reparation?</h2>
