...
export const metadata: Metadata = {
  title: "iPhone 8 Reparation - Frontdoorfix",
  description: "Vi tilbyder reparation af iPhone 8 – skærm, batteri, kamera, ladeport og mere med 24 måneders garanti. Hurtig service direkte på din adresse i København.",
  keywords: "iPhone 8 reparation, skærmreparation iPhone 8, batteriskift iPhone 8, kamera reparation, ladeport reparation, København",
};

export default function iPhone8Repair() {
  const repairs = [
    {
    ...
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-gray-600 mb-6">
              Professionel reparation af din iPhone 8 med originale Apple dele og 24 måneders garanti.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                <strong>Vi tilbyder reparation af iPhone 8</strong> – skærm, batteri, kamera, ladeport og mere med 24 måneders garanti. 
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Priser for iPhone 8 reparationer</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="mx-auto max-w-6xl px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Hvorfor vælge Frontdoorfix til din iPhone 8 reparation?</h2>
