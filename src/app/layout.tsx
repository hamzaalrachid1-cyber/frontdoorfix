              ...
              <nav className="flex items-center gap-8 text-base text-gray-700">
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                    <div className="py-2">
                      <a href="/reparationer/apple/iphone" className="block px-4 py-2 text-sm font-semibold text-gray-800 hover:bg-pink-500 hover:text-white transition-colors">iPhone</a>
                      <a href="/reparationer/apple/ipad" className="block px-4 py-2 text-sm font-semibold text-gray-800 hover:bg-pink-500 hover:text-white transition-colors">iPad</a>
                      <a href="/reparationer/apple/macbook" className="block px-4 py-2 text-sm font-semibold text-gray-800 hover:bg-pink-500 hover:text-white transition-colors">MacBook</a>
                ...
                <a href="/erhverv" className="nav-link">Erhvervsaftaler</a>
